...
confirm() ->
    ...
    logger:info("Fullsync not completed."),
    ...
    ?assertEqual(ok, R3),
    repl_util:wait_until_fullsync_started(LeaderA),
    logger:info("Fullsync running again."),
