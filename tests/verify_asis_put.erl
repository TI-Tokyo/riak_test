...
confirm() ->
    ...
    logger:info("Put object asis in ~p via PBC.", [Node1]),
    {ok, Obj2b} = rhc:put(HTTP1, Obj2a, [asis, return_body]),
    logger:info("Check vclock equality after asis put (HTTP)."),
