...
confirm() ->
    ...
    logger:info("Restart ~p and wait for ring convergence", [Node2]),
    rt:start(Node2),
    ...
    logger:info("Ensure all nodes are ready"),
